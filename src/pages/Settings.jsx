          ...
          {[
            {
              ...
              icon: <img src={googleGLogo} alt="" width={16} height={16} style={{ display: 'block', borderRadius: '50%' }} />,
            },
            {
            ...
            {gmailConnected ? (
              ...
              <div>
                <button
                  ...
                  disabled={gmailLoading}
                  aria-label={gmailLoading ? 'Connecting…' : 'Sign in with Google'}
                  style={{
                    background: 'none', border: 'none', padding: 0,
                ...
                >
                  <img src={googleSigninButton} alt="Sign in with Google" style={{ display: 'block', height: isMobile ? 44 : 40, width: 'auto' }} />
                </button>
