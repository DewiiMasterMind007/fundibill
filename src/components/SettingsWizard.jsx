...
const STEPS = [
  ...
  { openSectionId: 'payment', target: 'field-auto_reminders_enabled', title: 'Automatic Payment Reminders', description: 'Automatically email overdue clients a reminder — on the due date, then every 2 days until they pay. Only for invoices actually sent from the app.' },
